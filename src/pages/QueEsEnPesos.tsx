...
const quickFacts = [
  'Cotización asistida por WhatsApp para personas en Chile.',
  'Usa como referencia el cupo internacional disponible de una tarjeta de crédito.',
  'Te muestra una estimación en pesos chilenos antes de decidir si avanzar.',
  'No es un préstamo, avance bancario ni aumento de línea de crédito.',
];
            ...
            <div className="grid lg:grid-cols-[1.08fr_0.92fr] gap-10 lg:gap-14 items-center">
              <div>
                ...
                <div className="rounded-3xl border border-border bg-background/85 p-5 max-w-2xl">
                  <p className="text-sm font-extrabold uppercase tracking-[0.16em] text-primary mb-3">Resumen claro</p>
